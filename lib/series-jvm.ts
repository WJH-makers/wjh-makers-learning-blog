...
export const JVM_SEASONS: JavaSeason[] = [
  {
    ...
    episodes: [
      { season: 1, episode: 1, title: "炉中来客", summary: "简洁源文件与实例 main、模块导入声明:三行 void main() 点亮全屋,焰焰从炉口探出头初登场。", chapterType: "comic", projectStage: "后厨第一段 Java 25 代码", technologies: ["void main", "IO.println", "import module"], jobSkills: ["Java 25 新特性"], status: "planned" },
      ...
      { season: 1, episode: 6, title: "super 之前的自由", summary: "灵活构造器体:版本残影重演 1995 年「先喊 super 再干活」的老规矩,JDK 25 拆掉门禁先安检参数。", chapterType: "comic", projectStage: "构造器先安检再进门", technologies: ["灵活构造器体", "JEP 513"], jobSkills: ["Java 25 新特性"], status: "planned" },
  ...
  },
  {
    ...
    episodes: [
      ...
      { season: 2, episode: 5, title: "排队的艺术", summary: "Queue/Deque 家族:取餐队 FIFO、盘子叠放靠 ArrayDeque 双门神、VIP 优先出杯是 PriorityQueue 小顶堆。", chapterType: "comic", projectStage: "取餐队与 VIP 优先出杯", technologies: ["ArrayDeque", "PriorityQueue"], jobSkills: ["集合"], status: "planned" },
      { season: 2, episode: 6, title: "产消协奏曲", summary: "BlockingQueue 与生产者-消费者:出杯台满了咖啡师干等、空了取餐员干瞪眼,SynchronousQueue 是手递手窗口。", chapterType: "comic", projectStage: "出杯台变阻塞队列", technologies: ["BlockingQueue", "生产者-消费者"], jobSkills: ["并发", "集合"], status: "planned" },
      { season: 2, episode: 7, title: "字节的地下水道", summary: "IO 字节流装饰器与编码:裸字节走地下水道,Buffered 是蓄水罐,乱码等于 UTF-8 滤网装错型号。", chapterType: "comic", projectStage: "看懂乱码的第一性原理", technologies: ["InputStream", "Buffered", "UTF-8"], jobSkills: ["IO"], status: "planned" },
  ...
  },
  {
    ...
    episodes: [
      { season: 3, episode: 1, title: "十二枚会员徽章", summary: "枚举的本质:每枚徽章内置折扣算法(常量特定方法),焰焰揭秘枚举是编译器替你 new 好的一组单例。", chapterType: "comic", projectStage: "会员等级变纪律部队", technologies: ["enum", "常量特定方法"], jobSkills: ["枚举"], status: "planned" },
      { season: 3, episode: 2, title: "徽章专用工具箱", summary: "EnumMap/EnumSet 与枚举状态机:订单状态画成地铁线路图,EnumMap 是按徽章开槽的专属抽屉柜。", chapterType: "comic", projectStage: "订单状态机上线", technologies: ["EnumMap", "EnumSet", "状态机"], jobSkills: ["枚举"], status: "planned" },
      { season: 3, episode: 3, title: "镜之洞窟", summary: "反射 Class/Method/Field:炉底一面照出类骨架的镜子,隔镜拨动私有字段——照得越深代价越大。", chapterType: "comic", projectStage: "隔镜拨动私有字段", technologies: ["Class", "Method", "Field", "setAccessible"], jobSkills: ["反射"], status: "planned" },
      { season: 3, episode: 4, title: "自制迷你 Spring", summary: "注解 + 反射扫描:阿零 60 行代码写出 @Coffee 自动注入器,Spring 魔法书的第一页原来就是这个。", chapterType: "lab", projectStage: "60 行 @Coffee 注入器", technologies: ["注解", "反射扫描"], jobSkills: ["反射", "框架原理"], status: "planned" },
      { season: 3, episode: 5, title: "更快的镜子", summary: "卷终:MethodHandle 直通镜可内联、VarHandle 玩 CAS 硬币戏法,Class-File API 让阿零徒手改字节码。", chapterType: "project", projectStage: "徒手改字节码 · jvm-v3 魔法祛魅", technologies: ["MethodHandle", "VarHandle", "Class-File API"], jobSkills: ["JVM 底层"], status: "planned" },
    ],
  },
  {
    season: 4,
    ...
    episodes: [
      { season: 4, episode: 1, title: "一人一单的复活", summary: "虚拟线程:平台线程是编制 200 的正式工,虚拟线程一声令下十万临时工,人手一单从头跟到尾。", chapterType: "comic", projectStage: "十万订单人手一单", technologies: ["虚拟线程", "newVirtualThreadPerTaskExecutor"], jobSkills: ["并发"], status: "planned" },
      ...
      { season: 4, episode: 6, title: "何时仍需未来", summary: "CompletableFuture 的取舍:三方比价场景摆出决策天平——编排/超时/合并用 CF,同步直写用虚拟线程。", chapterType: "reference", projectStage: "三方比价的决策天平", technologies: ["CompletableFuture", "虚拟线程"], jobSkills: ["并发"], status: "planned" },
  ...
  },
  {
    ...
    episodes: [
      { season: 5, episode: 1, title: "尾巴变红之前", summary: "JVM 运行时区域与 JIT 分层编译:方法越热焰焰尾巴越红,C1 是速写素描、C2 是精修油画。", chapterType: "comic", projectStage: "看懂压测为何要预热", technologies: ["JIT", "C1/C2", "-XX:+PrintCompilation"], jobSkills: ["JVM"], status: "planned" },

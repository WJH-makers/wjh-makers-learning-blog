...
export const SEASONS: JavaSeason[] = [
  ...
  },
  {
    ...
    episodes: [
      { season: 3, episode: 1, title: "异常警报系统", summary: "Throwable 体系,checked vs unchecked。", chapterType: "comic", projectStage: "库存不足不再崩溃", technologies: ["Exception", "try/catch"], jobSkills: ["异常处理"], status: "planned" },
      { season: 3, episode: 2, title: "自定义业务异常", summary: "把业务错误变成清晰的异常类型。", chapterType: "comic", projectStage: "OutOfStockException", technologies: ["自定义异常"], jobSkills: ["异常处理"], status: "planned" },
      { season: 3, episode: 3, title: "文件与 Path API", summary: "Files / Path 持久化,关掉程序菜单还在。", chapterType: "comic", projectStage: "菜单存文件", technologies: ["Files", "Path", "NIO"], jobSkills: ["IO"], status: "planned" },
      { season: 3, episode: 4, title: "Lambda 与 Stream 流水线", summary: "filter / map / reduce 处理订单流水。", chapterType: "comic", projectStage: "统计当日销量", technologies: ["Lambda", "Stream"], jobSkills: ["函数式"], status: "planned" },
      { season: 3, episode: 5, title: "Maven 装备仓库", summary: "pom.xml / 依赖 / 生命周期 / 插件。", chapterType: "lab", projectStage: "项目由 Maven 管理", technologies: ["Maven", "pom.xml"], jobSkills: ["构建工具"], status: "planned" },
      { season: 3, episode: 6, title: "JUnit 质检员", summary: "「证据呢?」——用测试证明程序真的对。", chapterType: "comic", projectStage: "核心逻辑有测试", technologies: ["JUnit", "Mock"], jobSkills: ["测试"], status: "planned" },
      { season: 3, episode: 7, title: "Git 版本时间机", summary: "branch / merge / rebase。", chapterType: "lab", projectStage: "代码进 Git", technologies: ["Git"], jobSkills: ["版本控制"], status: "planned" },
      { season: 3, episode: 8, title: "多模块订单系统", summary: "第三季项目检查点。", chapterType: "project", projectStage: "多模块工程 v3", technologies: ["综合"], jobSkills: ["工程化"], status: "planned" },
    ],
  },
  {
    season: 4,
    ...
    episodes: [
      { season: 4, episode: 1, title: "HTTP 快递员", summary: "TCP/HTTP 基础:订单如何从手机到服务器。", chapterType: "comic", projectStage: "理解请求/响应", technologies: ["HTTP", "TCP"], jobSkills: ["网络"], status: "planned" },
      { season: 4, episode: 2, title: "第一个 Spring Boot 服务", summary: "内嵌服务器、自动配置的「地下机械图」。", chapterType: "comic", projectStage: "服务能启动", technologies: ["Spring Boot"], jobSkills: ["Spring Boot"], status: "planned" },
      { season: 4, episode: 3, title: "Controller / Service / Repository", summary: "分层与 IoC/DI:谁创建了对象。", chapterType: "comic", projectStage: "三层架构", technologies: ["Spring MVC", "IoC", "DI"], jobSkills: ["Spring Boot"], status: "planned" },
      { season: 4, episode: 4, title: "JDBC / MyBatis 连 MySQL", summary: "多台机器共享订单,数据落库。", chapterType: "comic", projectStage: "订单进 MySQL", technologies: ["JDBC", "MyBatis", "MySQL"], jobSkills: ["MySQL", "持久层"], status: "planned" },
      { season: 4, episode: 5, title: "参数校验与统一异常处理", summary: "把脏输入挡在门外,错误统一返回。", chapterType: "comic", projectStage: "健壮的 API", technologies: ["Validation", "@ControllerAdvice"], jobSkills: ["Spring Boot"], status: "planned" },
      { season: 4, episode: 6, title: "注册登录与 Spring Security", summary: "认证授权门。", chapterType: "comic", projectStage: "带权限的咖啡店", technologies: ["Spring Security"], jobSkills: ["Spring Security"], status: "planned" },
      { season: 4, episode: 7, title: "完整咖啡店 API", summary: "第四季项目检查点。", chapterType: "project", projectStage: "Spring Boot 单体 v4", technologies: ["综合"], jobSkills: ["Spring Boot", "MySQL"], status: "planned" },
    ],
  },
  {
    season: 5,
